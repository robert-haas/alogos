...
setup(
    ...
    description=(
        ...
        'Use a context-free grammar to define a formal language. '
        'Search for optimal strings in it as defined by a user-provided objective function.'
    ),
    ...
    install_requires=[
        'ordered_set>=3.0',         # preserve order of symbols in a grammar
        'lark-parser<1,>=0.6.5',    # parse any context-free grammar
        'railroad-diagrams<2,>=1',  # visualize a grammar
        'pylru<2,>=1.1',            # caching
        'gravis',                   # visualize an evolutionary algorithm run
    ],
