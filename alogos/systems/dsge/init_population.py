"""Initialization functions to generate a population for DSGE."""
        ...
        - Python: `dsge
          <https://github.com/nunolourenco/dsge>`__
            ...
            - `core/sge.py
              ...
              ``def generate_initial_population()`` is the implementation of population
              initialization by generating random genotypes
